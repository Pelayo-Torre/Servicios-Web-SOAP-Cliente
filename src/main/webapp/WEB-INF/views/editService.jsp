...
<body>
	...
	<h3 class="centered">Actualizar servicio.</h3>
	<br>
	<section>
		<c:if test="${ error ne '' }">
		...
		<div>
			<form:form modelAttribute="serviceEdit" action="/Amazin/services/edit" method="POST">
			  ...
			  <div class="form-group">
			    ...
			    <form:input type="number" path="price" step="0.01" class="form-control" id="exampleInputEmail" placeholder="Ej: 25.50"/>
			  </div>
			  <div class="form-group">
